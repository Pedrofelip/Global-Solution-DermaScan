...
export default function Consulta() {
  ...
  function cadastrarConsulta() {
    ...
    const dadosPerguntas = {
      condicoes_medicas: condicaoMedica,
      medicamentos: medicamentosUtilizados,
    };
              ...
              <div className={styles.grid_inputs}>
                ...
                <div className={styles.input2}>
                  ...
                  <input
                    ...
                    name="rua"
                    id="rua"
                    onChange={handleCompCasa}
                  />
                </div>
              </div>
              <button className={styles.btn} onClick={cadastrarConsulta}>
                Enviar
              </button>
            </form>
          </div>
